#!/bin/bash
# Debian Bookworm development environment setup script
...
curl -SL https://github.com/docker/compose/releases/download/v2.23.0/docker-compose-linux-$(uname -m) -o /usr/local/bin/docker-compose
...
# Install a nice theme (Powerlevel10k)
